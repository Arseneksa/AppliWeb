...
urlpatterns = [
    ...
    path('email', envoyer_mail, name="envoyer_mail"),
    ...
    path('account/favoris/add/<int:job_id>/', addfavoris, name="addfavoris"),
    path('account/favoris/del/<int:job_id>/', deletefavoris, name="deletefavoris"),
